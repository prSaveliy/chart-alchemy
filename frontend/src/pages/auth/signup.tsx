  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col">
      ...
      <div className="flex flex-1">
        {!emailSentShown && <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 pt-20 sm:pt-8">
          <form
        ...
        {emailSentShown && <div className="w-full lg:w-1/2 relative flex flex-col items-center justify-center p-4 sm:p-8 pt-20 sm:pt-8">
