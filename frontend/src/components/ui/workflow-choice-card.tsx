...
export const WorkflowChoiceCard = ({
  ...
  return (
    <button
      onClick={onClick}
      className="group flex w-full sm:w-80 h-auto sm:h-96 flex-col items-start text-left p-6 border rounded-2xl bg-white cursor-pointer transition-all duration-200 hover:border-black/40 hover:shadow-md hover:-translate-y-0.5"
    >
      ...
      <div className="mt-6 sm:mt-auto flex items-center gap-1.5 text-sm font-medium text-gray-700 group-hover:text-black">
        {cta}
